...
// function manualOrderMarket(){
// 	document.getElementById('limit_price').disabled = true;
// 	document.getElementById('limit_price').style.opacity = "0.6";
// 	document.getElementById('Qty').disabled = false;
// 	document.getElementById('Qty').style.opacity = "1";
// }

// function manualOrderLimit(checkBox){
// 	if (checkBox.value == 'limit'){
// 		document.getElementById('qty').disabled = true;
// 		document.getElementById('qty').style.opacity = "0.6";
// 	}else{
// 		document.getElementById('qty').disabled = false;
// 		document.getElementById('qty').style.opacity = "1";
// 	}
